    ...
    builder: (_, __) => Container(
      ...
      decoration: BoxDecoration(
        ...
        gradient: LinearGradient(
          ...
          colors: const [_kSurface, _kSurface2, Color(0xFF1E1E28), _kSurface2, _kSurface],
...
class _SocialScreenState extends State<SocialScreen> with TickerProviderStateMixin {
  ...
  void _snack(String msg, {bool error = false}) {
    ScaffoldMessenger.of(context).showSnackBar(SnackBar(
      ...
      backgroundColor: _kSurface3, behavior: SnackBarBehavior.floating,
          ...
          Expanded(child: Column(crossAxisAlignment: CrossAxisAlignment.start, children: [
            Row(crossAxisAlignment: CrossAxisAlignment.center, children: [
              Column(children: [
                ...
                Container(width: 1.5, height: 18, color: _kAccent),
              ]),
            ...
            Row(children: [
              ...
              Text('RED ACTIVA', style: TextStyle(
                color: _kGreenFg.withValues(alpha: 0.75),
                fontSize: 8, letterSpacing: 2.5, fontWeight: FontWeight.w700)),
              const SizedBox(width: 10),
              Container(width: 1, height: 8, color: _kLine2),
              const SizedBox(width: 10),
              Text(
                _miLiga.toUpperCase(),
          ...
          Container(
            ...
            child: Column(crossAxisAlignment: CrossAxisAlignment.end, children: [
              ...
              Text('PTS LIGA', style: TextStyle(
                color: _kSubtext, fontSize: 7, letterSpacing: 2, fontWeight: FontWeight.w700)),
            ]),
          ),
        ])),
      _buildSearchBar(),
      Container(decoration: BoxDecoration(border: Border(bottom: BorderSide(color: _kLine2))), child: _buildTabBar()),
    ]));
    ...
    return Padding(
      ...
      child: AnimatedContainer(
        ...
        decoration: BoxDecoration(
          ...
          border: Border.all(color: active ? _kAccent.withValues(alpha: 0.5) : _kLine2, width: active ? 1.5 : 1),
          borderRadius: BorderRadius.circular(10),
          boxShadow: active ? [BoxShadow(color: _kAccentGlow, blurRadius: 12)] : null),
        child: Row(children: [
          Padding(padding: const EdgeInsets.only(left: 14),
            child: Icon(Icons.search_rounded, color: active ? _kAccent : _kDim, size: 16)),
          Expanded(child: TextField(
            controller: _searchController,
            style: const TextStyle(color: _kText1, fontSize: 13, letterSpacing: 0.3),
            decoration: const InputDecoration(
              hintText: 'Buscar explorador...', hintStyle: TextStyle(color: _kDim, fontSize: 13),
              border: InputBorder.none, contentPadding: EdgeInsets.symmetric(horizontal: 10, vertical: 12)))),
          if (_buscando)
            ...
            GestureDetector(
              ...
              child: Padding(padding: const EdgeInsets.only(right: 14),
                child: Container(width: 18, height: 18,
                  decoration: BoxDecoration(color: _kDim, shape: BoxShape.circle),
                  child: const Icon(Icons.close_rounded, color: _kBg, size: 11)))),
        ])));
  }
  ...
  Widget _buildTabBar() => TabBar(
    ...
    labelColor: _kText1, unselectedLabelColor: _kSubtext,
  ...
  Widget _buildRankingTab() {
    ...
    return Column(children: [
      Padding(
        ...
        child: Container(
          height: 40,
          decoration: BoxDecoration(color: _kSurface, border: Border.all(color: _kLine2), borderRadius: BorderRadius.circular(10)),
          child: Row(children: [
            ...
            Container(width: 1, height: 22, color: _kLine2),
    ...
    return Padding(
      ...
      child: GestureDetector(
        ...
        child: Container(
          ...
          child: Row(children: [
            const Icon(Icons.arrow_back_ios_rounded, color: _kDim, size: 12),
            const SizedBox(width: 8),
            Text('Todas las ligas', style: TextStyle(color: _kText3, fontSize: 12, fontStyle: FontStyle.italic)),
            const Spacer(),
    ...
    return Column(crossAxisAlignment: CrossAxisAlignment.start, children: [
      Padding(
        ...
        child: Row(children: [
          ...
          const SizedBox(width: 8),
          const Text('TODAS LAS LIGAS', style: TextStyle(color: _kSubtext, fontSize: 8, fontWeight: FontWeight.w800, letterSpacing: 4)),
          const SizedBox(width: 8),
          Expanded(child: Container(height: 1, color: _kLine2)),
        ])),
            ...
            child: ClipRRect(
              ...
              child: Stack(children: [
                AnimatedContainer(
                  ...
                  decoration: BoxDecoration(
                    color: esMiLiga ? _kSurface3 : _kSurface,
                    border: Border.all(color: esMiLiga ? tierColor.withValues(alpha: 0.4) : _kLine2, width: esMiLiga ? 1.5 : 1),
                    borderRadius: BorderRadius.circular(10)),
                  child: Padding(
                    ...
                    child: Row(children: [
                      ...
                      Expanded(child: Column(crossAxisAlignment: CrossAxisAlignment.start, children: [
                        Row(children: [
                          Text(liga.name.toUpperCase(),
                            style: TextStyle(color: esMiLiga ? _kText1 : _kText2, fontSize: 13, fontWeight: FontWeight.w800, letterSpacing: 1.2)),
                          if (esMiLiga) ...[
                            const SizedBox(width: 8),
                            Container(
                      ...
                      bloqueada && !esMiLiga
                          ? Container(width: 30, height: 30,
                              decoration: BoxDecoration(color: _kSurface3, border: Border.all(color: _kLine2), borderRadius: BorderRadius.circular(6)),
                              child: const Icon(Icons.lock_outline_rounded, color: _kDim, size: 13))
                          : Icon(Icons.chevron_right_rounded, color: esMiLiga ? tierColor : _kDim, size: 20),
                    ]))),
        ...
        return Column(children: [
          Padding(padding: const EdgeInsets.fromLTRB(20, 10, 20, 4),
            child: Row(children: [
              ...
              const Spacer(),
              Text('${docs.length} exploradores', style: TextStyle(color: _kSubtext, fontSize: 10))])),
  ...
  Widget _buildFriendCard(Map<String, dynamic> data, String fid) {
    ...
    final Color territorioColor = colorInt != null ? Color(colorInt) : _kLine2;
  ...
  Widget _buildChatList() {
    return StreamBuilder<QuerySnapshot>(
      ...
      builder: (ctx, snapshot) {
        ...
        return RefreshIndicator(
          key: _rkMensajes, color: _kAccent, backgroundColor: _kSurface2,
          onRefresh: () async { setState(() {}); },
          child: ListView.builder(
  ...
  Widget _buildRequestsList() {
    return StreamBuilder<QuerySnapshot>(
      ...
      builder: (ctx, snapshot) {
        ...
        return RefreshIndicator(
          key: _rkSolici, color: _kAccent, backgroundColor: _kSurface2,
          onRefresh: () async { setState(() {}); },
          child: ListView.builder(
            physics: const AlwaysScrollableScrollPhysics(), padding: const EdgeInsets.fromLTRB(20, 14, 20, 32),
  ...
  void _confirmarRechazo(BuildContext ctx, String docId, String nickname) {
    showDialog(context: ctx, builder: (_) => AlertDialog(
      ...
      shape: RoundedRectangleBorder(borderRadius: BorderRadius.circular(12), side: const BorderSide(color: _kLine2)),
      title: const Text('Rechazar solicitud', style: TextStyle(color: _kText1, fontSize: 14, fontWeight: FontWeight.w800)),
      content: Text('¿Rechazar la solicitud de $nickname?', style: const TextStyle(color: _kText2, fontSize: 13)),
      actions: [
        TextButton(onPressed: () => Navigator.pop(ctx), child: const Text('Cancelar', style: TextStyle(color: _kText2))),
          ...
          child: Column(children: [
            Container(
              decoration: BoxDecoration(
                ...
                border: Border(bottom: BorderSide(color: _kLine2))),
            ...
            Padding(
              ...
              child: Column(crossAxisAlignment: CrossAxisAlignment.start, children: [
                Row(crossAxisAlignment: CrossAxisAlignment.end, children: [
                  Text('$puntosLiga',
                    style: const TextStyle(color: _kText1, fontSize: 56, fontWeight: FontWeight.w900, height: 0.9, letterSpacing: -3)),
                  Padding(padding: const EdgeInsets.only(bottom: 8, left: 6),
                    child: const Text('PTS', style: TextStyle(color: _kSubtext, fontSize: 13, fontWeight: FontWeight.w700, letterSpacing: 2))),
                  const Spacer(),
                  if (faltanPts > 0)
                    Container(
                      padding: const EdgeInsets.symmetric(horizontal: 12, vertical: 8),
                      decoration: BoxDecoration(color: _kSurface3, border: Border.all(color: _kLine2), borderRadius: BorderRadius.circular(8)),
                      child: Column(crossAxisAlignment: CrossAxisAlignment.end, children: [
                        Text('$faltanPts', style: const TextStyle(color: _kText1, fontSize: 18, fontWeight: FontWeight.w900, letterSpacing: -1)),
                        const Text('PARA ASCENDER', style: TextStyle(color: _kSubtext, fontSize: 7, letterSpacing: 1.5, fontWeight: FontWeight.w600)),
                      ])),
                ]),
                const SizedBox(height: 20),
                Row(mainAxisAlignment: MainAxisAlignment.spaceBetween, children: [
                  const Text('PROGRESO', style: TextStyle(color: _kSubtext, fontSize: 8, letterSpacing: 3, fontWeight: FontWeight.w700)),
                ...
                Row(children: List.generate(segs, (i) {
                  ...
                  return Expanded(child: Container(
                    ...
                    decoration: BoxDecoration(
                      color: active ? ligaInfo.color.withValues(alpha: 0.75) : current ? ligaInfo.color : _kLine2,
...
class _RankCard extends StatelessWidget {
  ...
  Widget build(BuildContext ctx) {
    ...
    final Color bar = esYo ? _kAccent : (top3 ? _medal : _kLine2);
      ...
      child: ClipRRect(
        ...
        child: Stack(children: [
          Container(
            ...
            decoration: BoxDecoration(
              color: top3 ? _kSurface2 : esYo ? _kAccent.withValues(alpha: 0.06) : _kSurface,
              border: Border.all(color: top3 ? _medal.withValues(alpha: 0.2) : esYo ? _kAccent.withValues(alpha: 0.3) : _kLine2),
              borderRadius: BorderRadius.circular(10)),
            child: Row(children: [
              SizedBox(width: 38, child: top3
                ? Text(['🥇','🥈','🥉'][posicion-1], style: TextStyle(fontSize: posicion==1?26:22), textAlign: TextAlign.center)
                : Text('#$posicion', style: TextStyle(color: esYo ? _kAccent : _kText3, fontWeight: FontWeight.w900, fontSize: 12), textAlign: TextAlign.center)),
              const SizedBox(width: 8),
              _Avatar(fotoBase64: fotoBase64, nickname: nickname, size: aSize,
                ringColor: top3 ? _medal.withValues(alpha: 0.5) : esYo ? _kAccent.withValues(alpha: 0.6) : ligaInfo.color.withValues(alpha: 0.35),
                glow: top3 || esYo),
              const SizedBox(width: 12),
              Expanded(child: Column(crossAxisAlignment: CrossAxisAlignment.start, children: [
                Text(nickname + (esYo ? ' (Tú)' : ''),
                  style: TextStyle(color: _kText1, fontWeight: top3 ? FontWeight.w900 : FontWeight.w600, fontSize: top3 ? 14 : 13),
                  overflow: TextOverflow.ellipsis),
                const SizedBox(height: 4),
                Row(children: [
                  Text('Niv. $nivel', style: TextStyle(color: _kSubtext, fontSize: 10)),
                  const SizedBox(width: 6),
              ...
              Column(crossAxisAlignment: CrossAxisAlignment.end, children: [
                Text('$puntosLiga',
                  style: TextStyle(color: top3 ? _medal : esYo ? _kAccent : _kText2,
                    fontWeight: FontWeight.w900, fontSize: top3 ? 20 : 15, letterSpacing: -0.5)),
                Text('pts', style: TextStyle(color: _kDim, fontSize: 9)),
              ]),
            ])),
          if (dest)
            Positioned(left: 0, top: 0, bottom: 0,
...
class _FriendCard extends StatelessWidget {
  ...
  Widget build(BuildContext ctx) {
    ...
    final Color tc = territorioColor == _kLine2 ? _kDim : territorioColor;
    return Container(
      margin: const EdgeInsets.only(bottom: 8),
      child: ClipRRect(
        borderRadius: BorderRadius.circular(12),
              ...
              Expanded(child: Column(crossAxisAlignment: CrossAxisAlignment.start, children: [
                ...
                Row(children: [
                  Text(
                    ...
                    style: TextStyle(
                      color: activo ? _kGreenFg.withValues(alpha: 0.7) : _kDim,
        ...
        child: Stack(children: [
          Container(
            ...
            decoration: BoxDecoration(
              ...
              border: Border.all(color: h ? _kAccent.withValues(alpha: 0.3) : _kLine2),
              borderRadius: BorderRadius.circular(12)),
            child: Row(children: [
              _Avatar(fotoBase64: fotoBase64, nickname: nickname, size: 46,
                ringColor: h ? _kAccent.withValues(alpha: 0.5) : _kLine2, glow: h),
              const SizedBox(width: 13),
              Expanded(child: Column(crossAxisAlignment: CrossAxisAlignment.start, children: [
                Text(nickname, style: TextStyle(color: h ? _kText1 : _kText2,
                ...
                Text(lastMessage.isEmpty ? 'Inicia la conversación' : lastMessage,
                  ...
                  style: TextStyle(color: h ? _kText3 : _kSubtext, fontSize: 12, fontStyle: FontStyle.italic)),
              ])),
              const SizedBox(width: 10),
              Column(crossAxisAlignment: CrossAxisAlignment.end, mainAxisAlignment: MainAxisAlignment.center, children: [
                Text(_fmt(lastTime), style: TextStyle(color: h ? _kAccent.withValues(alpha: 0.8) : _kDim,
...
class _PlayerCard extends StatelessWidget {
  ...
  Widget build(BuildContext ctx) {
    ...
    return _Press(onTap: onVerPerfil, child: Container(
      ...
      decoration: BoxDecoration(color: _kSurface, border: Border.all(color: _kLine2), borderRadius: BorderRadius.circular(12)),
      child: Row(children: [
        ...
        Expanded(child: Column(crossAxisAlignment: CrossAxisAlignment.start, children: [
          ...
          const SizedBox(height: 4),
          Text('$monedas 🪙  ·  Rango #$rango', style: TextStyle(color: _kSubtext, fontSize: 10)),
        ])),
        const SizedBox(width: 10),
...
class _RelBtn extends StatelessWidget {
  ...
  @override Widget build(BuildContext ctx) {
    ...
    if (relacion == 'pending') return Container(
      padding: const EdgeInsets.symmetric(horizontal: 10, vertical: 7),
      decoration: BoxDecoration(color: _kSurface3, border: Border.all(color: _kLine2), borderRadius: BorderRadius.circular(6)),
      child: Text('PENDIENTE', style: TextStyle(color: _kSubtext, fontSize: 9, fontWeight: FontWeight.w700)));
    ...
    return Container(
      ...
      child: Row(children: [
        ...
        Expanded(child: Column(crossAxisAlignment: CrossAxisAlignment.start, children: [
          ...
          const SizedBox(height: 5),
          Row(children: [
            Text('Nivel $nivel', style: TextStyle(color: _kText3, fontSize: 11)),
            const SizedBox(width: 6),
            _Pill(label: ligaInfo.name, color: ligaInfo.color, leading: ligaInfo.emoji),
          ]),
        ])),
        _Press(onTap: onRechazar, child: Container(
          width: 38, height: 38,
          decoration: BoxDecoration(color: _kSurface3, border: Border.all(color: _kLine2), borderRadius: BorderRadius.circular(8)),
          child: const Icon(Icons.close_rounded, color: _kText3, size: 16))),
        const SizedBox(width: 8),
  ...
  @override Widget build(BuildContext ctx) => Expanded(child: GestureDetector(
    ...
    child: AnimatedContainer(
      ...
      child: Row(mainAxisAlignment: MainAxisAlignment.center, children: [
        ...
        if (icon != null) Icon(icon, color: active ? activeColor : _kSubtext, size: 13),
        const SizedBox(width: 6),
        Text(label, style: TextStyle(color: active ? activeColor : _kSubtext, fontSize: 9, fontWeight: FontWeight.w800, letterSpacing: 2)),
      ]))));
}
    ...
    appBar: AppBar(
      ...
      title: Row(children: [
        ...
        Column(crossAxisAlignment: CrossAxisAlignment.start, children: [
          Text(widget.friendNickname, style: const TextStyle(color: _kText1, fontWeight: FontWeight.w700, fontSize: 13, letterSpacing: 0.3)),
          Row(children: [
      ...
      actions: [Padding(padding: const EdgeInsets.only(right: 16), child: const Icon(Icons.more_horiz, color: _kDim, size: 20))]),
    body: Column(children: [
      Expanded(child: StreamBuilder<QuerySnapshot>(
        stream: _msgsRef.orderBy('timestamp', descending: false).snapshots(),
        builder: (ctx, snapshot) {
          if (!snapshot.hasData) return const Center(child: SizedBox(width: 18, height: 18, child: CircularProgressIndicator(color: _kDim, strokeWidth: 1.5)));
          ...
          if (msgs.isEmpty) return Center(child: Column(mainAxisSize: MainAxisSize.min, children: [
            Container(width: 56, height: 56,
              decoration: BoxDecoration(color: _kSurface3, border: Border.all(color: _kLine2), borderRadius: BorderRadius.circular(14)),
              child: const Icon(Icons.chat_bubble_outline_rounded, color: _kDim, size: 22)),
            const SizedBox(height: 14),
            Text('¡Saluda a ${widget.friendNickname}!',
              style: const TextStyle(color: _kSubtext, fontSize: 13, fontStyle: FontStyle.italic)),
          ]));
          return ListView.builder(
        ...
        child: SafeArea(top: false, child: Row(children: [
          Expanded(child: Container(
            ...
            child: TextField(controller: _msgCtrl,
              ...
              decoration: const InputDecoration(
                hintText: 'Escribe un mensaje...', hintStyle: TextStyle(color: _kDim, fontSize: 13),
  ...
  @override Widget build(BuildContext ctx) => Padding(
    ...
    child: Align(
      ...
      child: Container(
        padding: const EdgeInsets.symmetric(horizontal: 14, vertical: 10),
        decoration: BoxDecoration(
          color: esMio ? _kText1 : _kSurface3,
        ...
        child: Column(
          ...
          children: [
            ...
            const SizedBox(height: 4),
            Text(hora, style: TextStyle(color: esMio ? _kBg.withValues(alpha: 0.4) : _kSubtext, fontSize: 9)),
          ]))));
}
...
class _ErrorState extends StatelessWidget {
  ...
  @override Widget build(BuildContext ctx) => Center(child: Column(mainAxisSize: MainAxisSize.min, children: [
    ...
    const Text('Error de conexión', style: TextStyle(color: _kText1, fontWeight: FontWeight.w700, fontSize: 14)),
    const SizedBox(height: 6),
    const Text('No se pudo cargar la información', style: TextStyle(color: _kText2, fontSize: 12, fontStyle: FontStyle.italic)),
    const SizedBox(height: 20),
    _Press(onTap: onRetry, child: Container(
      padding: const EdgeInsets.symmetric(horizontal: 18, vertical: 10),
      decoration: BoxDecoration(color: _kSurface3, border: Border.all(color: _kLine2), borderRadius: BorderRadius.circular(8)),
      child: const Row(mainAxisSize: MainAxisSize.min, children: [
        Icon(Icons.refresh_rounded, color: _kText2, size: 14), SizedBox(width: 7),
              ...
              _Press(
                ...
                child: Container(
                  ...
                  child: Text(accionLabel!,
                    style: const TextStyle(color: _kText2, fontSize: 12, fontWeight: FontWeight.w700)))),
            ],
          ],
        ),
      ),
...
class _ChatErrorState extends StatelessWidget {
  ...
  @override Widget build(BuildContext ctx) => Center(child: Padding(
    ...
    child: Column(mainAxisSize: MainAxisSize.min, children: [
      ...
      const SizedBox(height: 6),
      const Text('No se pudieron cargar los mensajes.', style: TextStyle(color: _kText2, fontSize: 12, fontStyle: FontStyle.italic), textAlign: TextAlign.center),
      const SizedBox(height: 14),
      Container(width: double.infinity, padding: const EdgeInsets.all(12),
        decoration: BoxDecoration(color: _kSurface, border: Border.all(color: _kLine2), borderRadius: BorderRadius.circular(8)),
        child: Row(crossAxisAlignment: CrossAxisAlignment.start, children: [
          const Icon(Icons.info_outline_rounded, color: _kDim, size: 12), const SizedBox(width: 8),
          Expanded(child: Text(error?.toString() ?? 'Error desconocido',
            style: const TextStyle(color: _kSubtext, fontSize: 10), maxLines: 3, overflow: TextOverflow.ellipsis)),
        ])),
    ])));
}